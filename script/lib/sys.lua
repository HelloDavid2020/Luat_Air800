...
--脚本发布时的最新core软件版本号
CORE_MIN_VER = "Luat_V0007_Air800"
...
local function checkcorever()
	...
	local buildver = string.match(realver,"Luat_V(%d+)_Air800")
	--如果底层软件版本号格式错误
	...
	if tonumber(string.match(CORE_MIN_VER,"Luat_V(%d+)_Air800"))>tonumber(buildver) then
